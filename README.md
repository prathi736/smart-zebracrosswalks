    ...
    <table>
        <tr>
            <td style="padding:10px">
                <img src="https://i.postimg.cc/hjMJyZGw/Splash-Screen.png" width="300" />
            </td>
            <td style="padding:10px">
                <img src="https://i.postimg.cc/8C9gv5Ys/Overlay-first-page.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/G2Dt86Xw/Upload-Images-before.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/1zw1pP1H/Select-image-gallery.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/Mp195GXv/Analyse-image.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
...
<div id="image-table" style="margin-left: auto;
    ...
    <table>
        ...
        <tr>
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/vmh7cgSw/Access-camera.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/mkHmn3TW/Image-clicked-camera.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
            ...
            <td style="padding:10px">
                <img src="https://i.postimg.cc/fL6KY3m2/Image-Analysis.png" width="300"/>
            </td>
        </tr>
        <tr>
            <td style="padding:10px">
